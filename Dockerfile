...
RUN DEBIAN_FRONTEND="noninteractive" apt-get update && \
    ...
    wget --no-check-certificate -cq "https://github.com/Kitware/CMake/releases/download/v3.25.3/cmake-3.25.3-linux-x86_64.sh" && \
    wget --no-check-certificate -cq "https://github.com/ninja-build/ninja/releases/download/v1.11.1/ninja-linux.zip" && \
