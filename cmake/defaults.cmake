...
if (NOT DEFINED LANCET_BUILD_ARCH OR LANCET_BUILD_ARCH STREQUAL "OFF" OR LANCET_BUILD_ARCH STREQUAL "")
	if (CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "arm64" OR CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL "aarch64")
		set(LANCET_BUILD_ARCH "native")
	else()
		set(LANCET_BUILD_ARCH "x86-64-v3")
	endif()
...
if (CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "arm64" OR CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL "aarch64")
	set(LANCET_OPT_FLAGS "-O3 -ffast-math -DNDEBUG -mcpu=${LANCET_BUILD_ARCH}" CACHE STRING "Lancet optimization flags" FORCE)
else ()
	set(LANCET_OPT_FLAGS "-O3 -ffast-math -DNDEBUG -m64 -march=${LANCET_BUILD_ARCH}" CACHE STRING "Lancet optimization flags" FORCE)
endif ()
